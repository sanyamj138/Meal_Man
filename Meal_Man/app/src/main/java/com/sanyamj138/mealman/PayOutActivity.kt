...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.payOutAmountText.isEnabled = false
        binding.payOutAmountText.setText(totalAmount)
        ...
        binding.PlaceMyOrder.setOnClickListener {
            ...
            name = binding.payOutNameEditText.text.toString().trim()
            address = binding.payOutAddressEditText.text.toString().trim()
            phone = binding.payOutPhoneEditText.text.toString().trim()
            ...
            userReference.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()){
                        ...
                        binding.apply {
                            payOutNameEditText.setText(names)
                            payOutAddressEditText.setText(addresses)
                            payOutPhoneEditText.setText(phones)
                        }
                    }
                }
